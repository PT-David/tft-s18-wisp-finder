...
- New-record \`id\` provenance inherits the approved \`riotId\` lineage because the ID is deterministically derived; \`patch\` uses the frozen-manifest Riot 18.1 source.
- Accepted-unknown Knowledge provenance is an explicit B2 review-governance binding, not an unrelated upstream field source.
